...
public class SimpleController implements Controller {
	...
	private ViewInventionFields viewInventionFields = new ViewInventionFields(
			this);
	...
	public void next(Object o, String moduleName, String command) {
		...
		if (command.equals("start")) {
			...
			if (command.equals("AddInventionField")) {
				...
				// management.setVisible(false);
				InventionFieldCatalog catalog = InventionFieldCatalog
						.getInstance();
				deleteInventionField.refreshData(new Object[] { catalog
						.getAllItems() });
				deleteInventionField.setVisible(true);
			} else if (command.equals("ViewInventionFields")) {
				InventionFieldCatalog catalog = InventionFieldCatalog
						.getInstance();
				viewInventionFields.refreshData(new Object[] { catalog
						.getAllItems() });
				...
				UserCatalog catalog = UserCatalog.getInstance();
				viewUserAccountSel.refreshData(new Object[] { catalog
						.getAllItems() });
